...
public class LPencucian extends Fragment {
    ...
    public void event(){
        ...
        wExport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DialogExport dialogExport = new DialogExport(getActivity(),"LPencucian",q) ;
    ...
    public void loadData(String cari){
        ...
        AdapterLapPencucian adapter = new AdapterLapPencucian(this,array) ;
        recyclerView.setAdapter(adapter);

        q = "select * from qorder where "+myApp.sqlBetweenDate(etDari.getText().toString(),etSampai.getText().toString())+" " +
                "and pelanggan like '%"+cari+"%' order by faktur desc" ;
    ...
    public void hapus(String faktur, final String idOrder){
        q = "delete from tblorder where faktur='" + faktur + "'" ;
